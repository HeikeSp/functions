...
func_anova_3fac <- function(normalized_values, trial_factors, factor1, factor2, factor3, threshold, analytes=analytes_6sel_exp_sort){
...
#     else  
  rownames(res_anova_adj) <- analytes$name
...
func_anova_2fac_ia <- function(normalized_values, trial_factors, factor1, factor2, threshold, analytes=analytes_6sel_exp_sort){
  res_anova <- matrix("NA", ncol=4, nrow=ncol(normalized_values))
  for (i in 1:ncol(normalized_values)){
    res_anova[i,] <- summary(aov(normalized_values[,i] ~ 
...
func_anova_1fac <- function(normalized_values, trial_factors, factor1, threshold, analytes=analytes_sel_exp_sort){
