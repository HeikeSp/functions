...
# SQL script: D:\work\TROST\Database\2014-07-29-bbch_query.sql

# solution for parametrization
...
# SQL script: D:\work\TROST\Database\2015-05-07-bbch_query_valdis.sql

func_get_bbch_data2 <- function(experiment_id = '47199' ){
