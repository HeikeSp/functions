...
cols_distinct_31 <- c("#67253a", "#d2486e", "#d28778", "#da4b33", "#883925", "#d48b3a", "#d6c49f", 
                      "#8a7539", "#d7c73b", "#3c3b23", "#cccb70", "#b6e542", "#6ba639", "#446c2a", 
                      "#abdb95", "#61db55", "#4fa773", "#63e5a2", "#618570", "#b1d7cc", "#5dd3d0",
                      "#3c6172", "#78a8d0", "#7578ce", "#392f50", "#6643c9", "#592c7a", "#c648d5",
                      "#d7a5ce", "#c953a6", "#8e687d")
